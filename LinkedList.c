        ...
        do
        {
            ...
            for(i=0 ; i < lenLinkedList ; i ++)
            {
                ...
                case 0:
                    ...
                    {
                        flag = 1;
                        ll_set(this, i, auxNode2); ///SUPONIENDO QUE I ES 1 , EL auxNODO 1 PASA A TENER EL ELEMENTO DEL NODO 2
                        ll_set(this, i + 1, auxNode); /// Y EL auxNODO 2, TIENE AHORA EL ELEMENTO DEL NODO 1
                    }
                    break;
                case 1:
                    if(auxCmp > 0)
...
LinkedList* ll_filter(LinkedList* this, int (*fn)(void* element))
{
    ...
    if(this!= NULL && fn != NULL)
    {
        ...
        for(i = 0; i < lenll; i++)
        {
            ...
            if(fn(auxElement))
            {
                if(ll_add(auxList, auxElement) == -1)
                {
                    auxList = NULL;
                }
            }
